<template>
    ...
    <div class="w-3/4 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30" :class="sideBarOpen ? '' : 'hidden'" id="main-nav"
         @sidebarChangeState="changeSideBar"
    >

          <div class="w-full h-20 border-b flex px-4 items-center mb-8">
            <p class="font-semibold text-3xl text-blue-400 pl-4">Base Dash</p>
          </div>
          ...
          <div class="mb-4 px-4" v-if="$page.props.jetstream.hasTeamFeatures">
